...
at the same time it uses an high level print(f-alike API in order to make it
...
`redisCommand`. This function takes a format similar to print(f. In the simplest form,
